...
class ProductsWishesControllerTest < ActionController::TestCase
  ...
  test "should create products_wish" do
    assert_difference('ProductsWish.count') do
      post :create, params: { products_wish: { product_id: @products_wish.product_id, wish_id: @products_wish.wish_id } }
    end
  ...
  test "should show products_wish" do
    get :show, params: { id: @products_wish }
    assert_response :success
  end

  test "should update products_wish" do
    patch :update, params: { id: @products_wish, products_wish: { product_id: @products_wish.product_id, wish_id: @products_wish.wish_id } }
    assert_response 200
  end

  test "should destroy products_wish" do
    assert_difference('ProductsWish.count', -1) do
      delete :destroy, params: { id: @products_wish }
    end
